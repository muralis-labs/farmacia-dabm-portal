...
const Layout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const selectedPath = useMemo(
    () => menus.find((menu) => menu.route === pathname),
    [menus, pathname]
  );
  ...
  const renderSideBar = () =>
    !pathname.includes("/pages/login") &&
    !isMobile && <CustomSideBar menus={menus} selectedPath={pathname} />;
  ...
  const renderMobileFooter = () =>
    !pathname.includes("/pages/login") &&
    !isScanning &&
    isMobile && <CustomFooter menus={mobileMenus} selectedPath={pathname} />;
